...
import type { CompanyRegistrationRequest } from "../api/authApi";
...
type CompanyRegistrationRules = {
  companyName: RegisterOptions<CompanyRegistrationRequest, "companyName">;
  industry: RegisterOptions<CompanyRegistrationRequest, "industry">;
  companyEmail: RegisterOptions<CompanyRegistrationRequest, "companyEmail">;
  companyAddress: RegisterOptions<CompanyRegistrationRequest, "companyAddress">;
  companyPhoneNumber: RegisterOptions<
    CompanyRegistrationRequest,
    "companyPhoneNumber"
  >;
  ownerName: RegisterOptions<CompanyRegistrationRequest, "ownerName">;
  ownerEmail: RegisterOptions<CompanyRegistrationRequest, "ownerEmail">;
  password: RegisterOptions<CompanyRegistrationRequest, "password">;
};
...
export const companyRegistrationValidationSchema: CompanyRegistrationRules = {
  ...
  companyEmail: {
    ...
    maxLength: {
      value: 255,
      message: "Company email must not exceed 255 characters.",
    },
  },
  ...
  ownerEmail: {
    ...
    maxLength: {
      value: 255,
      message: "Owner email must not exceed 255 characters.",
    },
  },
...
export const createConfirmPasswordValidation = (
  password: string,
): RegisterOptions<CompanyRegistrationRequest, "confirmPassword"> => ({
  required: "Confirm password is required.",
  validate: (value) =>
    value === password || "Password and confirm password must match.",
});
